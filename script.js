...
function calculate() {
    ...
    const calculateOptions = Array.from(document.getElementById('calculateOptions').selectedOptions).map(option => option.value);
    ...
    if (calculateOptions.includes('angles')) {
        ...
        <ul>
            <li>Угол при основании 1 (α): ${angles[0]}°</li>
            <li>Угол при основании 2 (β): ${angles[1]}°</li>
            <li>Угол при боковой стороне 1 (γ): ${angles[2]}°</li>
            <li>Угол при боковой стороне 2 (δ): ${angles[3]}°</li>
        </ul>`;
    }
}
